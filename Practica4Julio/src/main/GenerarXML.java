...
public class GenerarXML {
	 ...
	 */	
	public static String generar ( List<String> lConcepts, Map<String, Map<String,String>> mDatasets, String sCode, Map<String, List<Map<String,String>>> mDatasetConcepts){
