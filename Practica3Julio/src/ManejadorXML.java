...
public class ManejadorXML extends DefaultHandler implements ParserCatalogo {
	...
	private Map<String, Map<String, String>> hDatasets;
	 ...
	 */
	public ManejadorXML(String sCodConcepto) throws SAXException, ParserConfigurationException {
		sNomCategoria = sCodConcepto;
		lConcepts = new ArrayList<String>(); // Lista de Concepts
		hDatasets = new HashMap<String, Map<String, String>>(); // HashMap de lod Datasets
	...
	/**
	 * Analizamos que elemento ha sido detectado, no se hacen distinciones entre
	 * mayusculas y minusculas
	 * el objetivo de esta funcion es controlar en que nivel se encuentra e ir
	 * preparando los mapas para
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
		...
		if (qName.equalsIgnoreCase("concept")) {
			// dentro de un concept puede haber otro concept
	...
	/**
	 * Se analiza en primer lugar cual es elemento que ha terminado, sin distinguir
	 * entre mayusculas o minusculas
	 * Esta funcion se encarga de annadir los elementos a los mapas para luego
	 * pasarlos al generador
	 **/
	@Override
		...
		switch (qName) {
			case "concept":
				if (insideDataset) {
					...
					if (numConcepts > conceptCodEncontrado && !lConcepts.contains(tempURL)) {
						lConcepts.add(tempURL);
