...
public class AnalizadorXML extends DefaultHandler implements ParserCatalogo {
	...
	* *******************************************************************************************************/
	...
	public void startDocument() throws SAXException {
		super.startDocument();
		System.out.println("[+] Se ha comenzado a analizar el documento gracias al AnalizadorXML...");
	}
	...
	public void endDocument() throws SAXException {
		super.endDocument();
		System.out.println("[+] Se ha terminado de analizar el documento gracias al AnalizadorXML...");	
	}
